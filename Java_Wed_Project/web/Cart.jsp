                        ...
                        <div class="row">
                            ...
                            <c:set var="total" value="${total +l.price*l.quantity }"></c:set>
                                <tr>
                                    <td>
                                        <figure class="media">
                                            <div class="img-wrap"><img width="400" height="400" src="${l.image}" class="img-thumbnail img-sm"></div>
                                ...
                                <td class="text-right"> 
                                    ...
                                    <a href="removeCart?pid=${l.pid}" class="btn btn-outline-success">Delete</a>
                                </td>
                            </tr>
                        </form>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    ...
                                    </ul><a href="checkoutbill.jsp" class="btn btn-dark rounded-pill py-2 btn-block">Mua hàng</a>
                                </div>
                            </div>
                        </div>                       
